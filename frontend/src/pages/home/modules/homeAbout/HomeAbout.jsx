...
import pix2 from '../../../../assets/pix-7.jpg';
...
const HomeAbout = () => {
	return (
		<Styles.HomeAboutContainer>
			<Styles.HomeAboutPicWrapper>
				<Styles.HomeAboutPicFirst>
					<FadeInAlways delay={0.2} direction='down'>
						<img src={pix1} alt='' loading='lazy' />
					</FadeInAlways>
				</Styles.HomeAboutPicFirst>
				<Styles.HomeAboutPicBox>
					<Styles.HomeAboutPicSecond>
			...
			<Styles.HomeAboutInfoContainer>
				...
				<Styles.HomeAboutInfoTextContainer>
				...
				<Styles.HomeAboutMissionContainer>
					<div>
						<FadeInAlways delay={0.7} direction='left'>
							<h4>Our mission</h4>
							<p>
								To always deliver competent and credible information technology
								services to our clients, at best cost effective rates, and to
								meet our clients’ quality expectation & delivery to ensure their
								projects succeed regardless the challenges encountered, while
								ensuring health, safety and environmental best practices.
							</p>
						</FadeInAlways>
					</div>
					<div>
						<FadeInAlways delay={0.8} direction='left'>
							...
							<p>
								...
								consistently on time, in safety and in accordance with industry
								best practices and thus become the preferred vendor of goods ad
								services in our chosen fields.
							</p>
						</FadeInAlways>
					</div>
				</Styles.HomeAboutMissionContainer>
