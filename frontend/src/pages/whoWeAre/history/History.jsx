			...
			<Styles.HistoryContainer>
				...
				<Styles.HistoryContentContainer>
					...
					<FadeInAlways delay={0.5} direction='right'>
						...
						{/* <p>
							Though the Company was incorporated on the 5th of September, 2014,
							the combined relevant professional experience of the Management is
							over 100 years. At JOSHCALEBWILL, we offer a wide range of
							services that cut across the entire value Chain of the Oil and Gas
							Industry which are administered with dedication to high level of
							professioanl excellence. Our work disciplines are organized into
							projects. Highly experience Project managers head every project
							and operations are integrated via our state of environment.
						</p> */}
						<p>
					...
					<FadeInAlways delay={0.7} direction='right'>
						...
						{/* <p>
							We adopt global best practices, processes, systems and standards
							in our Project execution to ensure that we deliver Project Scope
							on time and within Budget. We use traditional, hybrid and
							computerized methods in Project Analysis, Design and
