			...
			<ReactLenis root>
				...
				<Styles.CultureInfo>
					<Copy delay={0.5}>
						<p>
							...
							become an integrated solutions provider within the industry,
							offering a wide range of bespoke services that cover the entire
							value chain—from upstream exploration to infrastructure
				...
				<Styles.HistoryContent>
						...
						<p>
							...
							combined professional experience of its management team exceeds
							100 years. This wealth of experience forms the foundation for the
					...
					<div>
						<FadeInAlways delay={0.6} direction='right'>
							...
							<p>
								Joshcalebwill Petroluem Limited specializes in a broad spectrum
								of services within the Oil & Gas industry, including but not
								limited to:
							</p>
						</FadeInAlways>
						<FadeInAlways delay={0.6} direction='right'>
						...
						<FadeInAlways delay={0.6} direction='right'>
							<p>
								...
								each headed by highly experienced project managers. Operations
								are integrated and executed through a state-of-the-art
								environment that supports innovation, safety, and integrity.
							</p>
						</FadeInAlways>
						...
						<FadeInAlways delay={0.7} direction='right'>
							...
							<p>
								Safety: Prioritizing safe practices in every aspect of
								operations.
							</p>
							<p>
						...
						<FadeInAlways delay={0.8} direction='right'>
							...
							<p>
								The management team is deeply committed to total quality
								control, continuously training staff to meet identified training
								needs aligned with the company’s corporate goals and objectives.
							</p>
						</FadeInAlways>
						...
						<FadeInAlways delay={0.8} direction='right'>
							...
							<p>
								...
								delivering sustainable and value-driven outcomes at every stage
								of the project lifecycle. Their approach is rooted in core
								values that emphasize excellence, client satisfaction, and
								industry leadership.
							</p>
						</FadeInAlways>
						...
						<FadeInAlways delay={0.8} direction='right'>
							...
							<p>
								...
								established itself as a reliable and innovative player in the
								Oil & Gas sector. With a highly experienced management team, a
