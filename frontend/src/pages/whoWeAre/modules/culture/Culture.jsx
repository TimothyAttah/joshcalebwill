			...
			<Styles.Culture>
				<Styles.CultureInfo>
					<p>
						...
						values a diversity of perspectives, productive dialogue and teaming
						that help us deliver the future of energy.
					</p>
				</Styles.CultureInfo>
					...
					<Styles.CultureOptionsList>
						...
						<Styles.CultureOptionsListInfo first>
							...
							<p>
								...
								obstacle. Our vision and purpose drives how we work. And
								together we’re working to advance a lower carbon future.
							</p>
					...
					<Styles.CultureOptionsList>
						...
						<Styles.CultureOptionsListInfo third>
							...
							<p>
								...
								good health, well-being and work-life balance. We develop
								leaders to sustain and strengthen our culture for the future.
							</p>
						</Styles.CultureOptionsListInfo>
					</Styles.CultureOptionsList>
				</Styles.CultureOptions>
