			...
			<ReactLenis root>
				...
				<Styles.CultureInfo>
					...
					<Copy delay={0.5}>
						<p>
							...
							and sustainably. Our chemical supply chain is built on
							reliability, quality assurance, and tailored service, ensuring
							that every product we deliver meets the highest industry
							standards.
						</p>
					</Copy>
				</Styles.CultureInfo>
				<Styles.ChemicalContainer>
					<Styles.ChemicalOptionsContainer>
						...
						<Styles.ChemicalOptionsInfo>
							...
							<Copy delay={0.5}>
								<p>
									We specialize in sourcing, supplying, and applying a wide
									range of industrial chemicals for sectors including:
								</p>
							</Copy>
							...
							<Copy delay={0.5}>
								<ul>
									...
									<li>
										...
										purification chemicals for potable and industrial water
										systems.
									</li>
									<li>
										<span>Manufacturing</span> – specialty chemicals for
										production lines, cleaning, and maintenance.
									</li>
									<li>
										<span>Agriculture</span> – fertilizers, soil conditioners,
					...
					<Styles.ChemicalOptionsContainer primary>
						...
						<Styles.ChemicalOptionsInfo>
							...
							<Copy delay={0.5}>
								<p>
									Beyond supplying chemicals, we provide treatment programs
									designed to optimize your processes, protect your assets, and
									minimize downtime. Our treatment services include:
								</p>
							</Copy>
							<Copy delay={0.5}>
								<ul>
									...
									<li>
										<span>Environmental Compliance</span> – ensuring your
										chemical applications meet regulatory and safety standards.
									</li>
								</ul>
							</Copy>
						</Styles.ChemicalOptionsInfo>
				...
				<Styles.ChooseUs>
					...
					<Copy delay={0.5}>
						<ul>
							<li>
								<span>Quality Assurance</span> – All products sourced from
								trusted, certified manufacturers.
							</li>
							<li>
								<span>Custom Solutions</span> – Treatments tailored to your
							...
							<li>
								<span>Sustainability Focus</span> – Eco-friendly options to
					...
					<div>
						...
						<Copy delay={0.5}>
							<p>
								📞 Get in touch today to discuss your chemical supply and
								treatment needs.
							</p>
						</Copy>
						<button>
...
export default Transition(Chemical);
