...
export const ExplorationHero = styled.div`
	width: 100%;
	height: 100vh;
...
`;
export const ExplorationOptionsContainer = styled.div`
	max-width: 1300px;
	width: 100%;
	margin: 50px auto;
	display: flex;
...
`;
export const ExplorationOptionsImg = styled.div`
	max-width: 600px;
	width: 100%;
	height: 500px;
...
export const ExplorationOptionsInfo = styled.div`
	max-width: 600px;
	width: 100%;
	color: #fff;
