...
import { useFetchAllProductsQuery } from '../../../../reduxMarket/features/products/productsApi';
const filters = {
	categories: [
		'all',
		'lubricants',
	...
	priceRanges: [
		...
		{ label: 'N30000- N50000', min: 31000, max: 50000 },
		{ label: 'N51000 - N100000', min: 51000, max: 100000 },
